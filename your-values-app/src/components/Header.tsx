        ...
        <div className="flex gap-3 p-4">
            <Link to="/">
                <div className="flex gap-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="size-15 fill-violet-50" viewBox="0 0 16 16">
                    ...
                    <div className="self-center text-2xl text-violet-50 font-bold">Your Values</div>
                </div>
            </Link>
        </div>
    )
